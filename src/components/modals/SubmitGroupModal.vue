  ...
  <div  id="group-invite-modal"  style="z-index: 99999"  class="max-w-xl  mx-auto overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-20 justify-center items-center h-modal md:h-full md:inset-0">
    <div class="relative px-4 w-full max-w-2xl h-full md:h-auto">
      <div class="relative rounded-lg shadow bg-primary-700">
        ...
        <div class="px-6 pb-6 rounded-t border-b border-primary-600">
          <label for="email-adress-icon" class="block mb-2 pt-6 text-sm font-medium text-primary-400">Name :</label>
          <div class="relative mt-1">
            <input id="title" type="text" v-model="group.title" class="border border-primary-300 text-sm rounded-lg block w-full p-2.5 bg-primary-700 border-primary-600 placeholder-primary-400 text-white focus:ring-primary-500 focus:border-primary-500" placeholder="Group name">
          </div>
        ...
        <div class="flex items-center p-6 space-x-2 rounded-b border-t border-primary-600">
          <button v-on:click="submitGroup()" data-modal-toggle="default-modal" type="button" class="focus:ring-4 focus:ring-primary-300 rounded-lg border  text-sm font-medium px-5 py-2.5  focus:z-10 text-white hover:bg-primary-600">Create</button>
        </div>
      </div>
    </div>
  </div>
