...
<!--        </div>-->
        <div class="m-5" v-show="requestModal.textInput">
          <label class="block mb-2 text-sm font-medium text-gray-400">Your message</label>
          <textarea id="message" v-model="message" rows="4" class="block p-2 w-full text-sm  rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500focus:border-blue-500" placeholder="Leave a message..."></textarea>
        </div>
        <div class="m-5" v-show="requestModal.textInput">
