  ...
  <div id="default-modal" aria-hidden="true"  style="z-index: 999999" class="max-w-xl mt-20 mx-auto overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 justify-center items-center h-modal md:h-full md:inset-0">
    <div class="relative px-4 w-full max-w-2xl h-full md:h-auto">
      <div class="relative rounded-lg shadow bg-primary-700">
        <div class="flex justify-between items-start p-5 rounded-t border-b border-primary-600">
          <h3 class="text-xl font-semibold  lg:text-2xl text-white">
            🔒 One more step...
          </h3>
          <button type="button" v-on:click="closeModal()" class="text-primary-400 bg-transparent  rounded-lg text-sm p-1.5 ml-auto inline-flex items-center hover:bg-primary-600 hover:text-white" data-modal-toggle="default-modal">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </button>
        </div>

        <div class="p-2 md:p-6 space-y-6 border-b border-primary-600">
          <p class="hidden md:inline text-base leading-relaxed text-primary-400">
          ...
          <table class="min-w-full">
            ...
            <tr>
              <th scope="col" class="py-3 text-xs font-medium tracking-wider text-left  uppercase text-primary-400">
                Requirement :
              </th>
              <th scope="col" class="py-3 text-xs font-medium tracking-wider text-left  uppercase text-primary-400">
                Link
           ...
           <tr>
            <td class="text-white"><b>90+</b> friends on facebook</td>
             <td><v-facebook-login :logo-class="'inline mr-2'"	 class="text-primary-400" @login="onLogin" v-model="model" :login-options="{scope: 'user_friends'}" @sdk-init="handleSdkInit" :app-id="app_id"></v-facebook-login>
           ...
           <tr>
             ...
             <td class="flex my-2">
               <input type="text" v-model="manualToken.value" id="small-input" placeholder="ABCD000" class="block p-2 w-full rounded-l-lg border-l  sm:text-xs  bg-primary-400 border-primary-600 placeholder-white text-white focus:ring-offset-transparent">
               <button v-on:click="setManualToken()" type="submit" class="text-white  focus:ring-4  font-medium rounded-r-lg text-sm px-2  text-center bg-primary-600 hover:bg-primary-700 focus:ring-primary-800">
        ...
        <div class="flex justify-between items-start p-5 rounded-t">
          <h3 class="text-md font-semibold  lg:text-md text-white">
            <table class="min-w-full">
              ...
              <tr>
                <td class="text-white">
                  <a href="https://calendly.com/nomadgroups/account-verification"  type="button" class="text-primary-900 bg-primary-100 bg-opacity-50 hover:bg-primary-200 focus:ring-4 font-medium rounded-lg text-sm px-3 py-2.5 text-center inline-flex items-center focus:ring-primary-500 mr-2 mb-2">
