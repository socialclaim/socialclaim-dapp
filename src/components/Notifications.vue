<template>
  ...
  <div v-if="state === 'afterVerificationRequest'" class=" max-w-md bg-white rounded-lg  shadow-md shadow-white dark:bg-gray-800 dark:border-gray-700">
    <div class="p-4 mb-2 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-secondary dark:text-white  " role="alert">
