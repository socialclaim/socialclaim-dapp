<template>
  ...
  <div v-if="state === 'afterVerificationRequest'" class=" max-w-md bg-white rounded-lg  shadow-md  dark:bg-gray-800 dark:border-gray-700">
    <div class="p-4 mb-2 text-sm text-blue-700 bg-blue-100 rounded-lg dark:bg-blue-200 dark:text-blue-800" role="alert">
      ...
      <span class="font-medium inline-block">Waiting for challenge to be generated...<br /> Please do not close the window<br /> Follow the progress on <a target="_blank" class="text-blue-300 underline" href="https://vrf.chain.link/chapel/888">ChainLink VRF</a></span>
    </div>
  </div>
